(() => {
  ...
  const translations = {
    vi: {
      ...
      removeSaved: "Bỏ lưu",
      compareEyebrow: "So sánh laptop",
      compareTitle: "Đặt 2 máy cạnh nhau",
      compareCopy: "Chọn hai mẫu laptop để xem nhanh chênh lệch giá, nơi bán tốt nhất và các thông số nổi bật.",
      compareViewProducts: "Xem danh sách",
      compareNoDataTitle: "Chưa đủ dữ liệu để so sánh",
      compareNoDataCopy: "Cần ít nhất 2 sản phẩm. Hãy import dữ liệu hoặc chạy crawler trước.",
      compareFirst: "Máy thứ nhất",
      compareSecond: "Máy thứ hai",
      compareSubmit: "So sánh",
      compareImagePending: "Chưa có ảnh",
      compareModelKey: "Mã nhận diện:",
      compareBestPrice: "Giá tốt nhất hiện có",
      compareUnknownShop: "Chưa rõ nơi bán",
      compareTableTitle: "Bảng so sánh thông số và giá",
      compareCriteria: "Tiêu chí",
      compareMachineOne: "Máy 1",
      compareMachineTwo: "Máy 2",
      compareBestShop: "Nơi bán tốt nhất",
      compareAveragePrice: "Giá trung bình",
      compareAvailableSites: "Số website còn hàng",
      compareNoValue: "Chưa có dữ liệu",
      compareDetailSpecs: "Thông số chi tiết",
      compareShopPricePrefix: "Giá theo shop - Máy",
      compareInStock: "Đang kinh doanh",
      compareOutOfStock: "Không kinh doanh",
      compareNoPrice: "Không có giá",
      compareChatTitle: "Trợ lý phân tích 2 máy",
      compareSuggestionValue: "Đáng tiền",
      compareSuggestionSpecs: "Thông số",
      compareSuggestionGaming: "Chơi game",
      compareSuggestionOffice: "Học/văn phòng",
      compareQuestionValue: "Máy nào đáng tiền hơn?",
      compareQuestionSpecs: "So sánh thông số 2 máy",
      compareQuestionGaming: "Máy nào hợp để chơi game hơn?",
      compareQuestionOffice: "Máy nào hợp để học và văn phòng hơn?",
      comparePlaceholder: "Hỏi thêm về hai máy này...",
      compareLoading: "Đang phân tích hai máy...",
      compareFallback: "Không lấy được câu trả lời.",
      compareConnectError: "Không kết nối được chatbot.",
    },
    en: {
      languageControl: "Language",
      languageName: "EN",
      ...
      removeSaved: "Remove",
      compareEyebrow: "Laptop comparison",
      compareTitle: "Compare two laptops side by side",
      compareCopy: "Choose two laptop models to review price gaps, best retailers, and key specs at a glance.",
      compareViewProducts: "View products",
      compareNoDataTitle: "Not enough data to compare",
      compareNoDataCopy: "At least 2 products are required. Import data or run the crawler first.",
      compareFirst: "First laptop",
      compareSecond: "Second laptop",
      compareSubmit: "Compare",
      compareImagePending: "No image yet",
      compareModelKey: "Model key:",
      compareBestPrice: "Best available price",
      compareUnknownShop: "Unknown retailer",
      compareTableTitle: "Specs and price comparison",
      compareCriteria: "Criteria",
      compareMachineOne: "Laptop 1",
      compareMachineTwo: "Laptop 2",
      compareBestShop: "Best retailer",
      compareAveragePrice: "Average price",
      compareAvailableSites: "Retailers in stock",
      compareNoValue: "No data yet",
      compareDetailSpecs: "Detailed specs",
      compareShopPricePrefix: "Retailer prices - Laptop",
      compareInStock: "Available",
      compareOutOfStock: "Unavailable",
      compareNoPrice: "No price",
      compareChatTitle: "Two-laptop advisor",
      compareSuggestionValue: "Best value",
      compareSuggestionSpecs: "Specs",
      compareSuggestionGaming: "Gaming",
      compareSuggestionOffice: "Study/office",
      compareQuestionValue: "Which laptop is better value?",
      compareQuestionSpecs: "Compare the specs of these two laptops",
      compareQuestionGaming: "Which one is better for gaming?",
      compareQuestionOffice: "Which one is better for study and office work?",
      comparePlaceholder: "Ask about these two laptops...",
      compareLoading: "Analyzing both laptops...",
      compareFallback: "Could not get an answer.",
      compareConnectError: "Could not connect to the chatbot.",
    },
  };
